...
public class BarangKeluar extends javax.swing.JFrame {
    ...
    private void koneksi2() throws ClassNotFoundException, SQLException{
            Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection("jdbc:mysql://localhost/rpl101", "root", "");
    ...
    private void tabel(){
        ...
        tb.addColumn("Jumlah");
        tb.addColumn("Tgl Keluar");
        tabeldata.setModel(tb);
        
        try{
            // Mengambil data dari database
            res = stat.executeQuery("select * from brg_keluar");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MENU INPUT BARANG KELUAR");
    ...
    private void simpan_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpan_btnActionPerformed
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/rpl101", "root", "");
            Statement smt;
            String sql = "INSERT INTO brg_keluar (kdbrg, nama_brg, jenis_brg, jumlah, tgl_keluar) "
            ...
            if(Simpan > 0){
                JOptionPane.showMessageDialog(this, "data berhasil disimpan", "pesan", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            }else{
                JOptionPane.showConfirmDialog(this, "data gagal disimpan", "pesan", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            }        
            kdbrg.setText("");
            namabrg.setText("");
            jnsbrg.setText("");
